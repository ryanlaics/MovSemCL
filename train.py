...
from model.semmovcl import SemMovCLTrainer
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description = "SemMovCL/train.py")
...
if __name__ == '__main__':
    ...
    semmovcl = SemMovCLTrainer(Config.semmovcl_aug1, Config.semmovcl_aug2)
    semmovcl.train()
    semmovcl.test()
